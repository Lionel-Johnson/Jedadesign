...
define('DB_SERVER', 'sql304.infinityfree.com');
   define('DB_USERNAME', 'if0_36726746');
   define('DB_PASSWORD', ' @Lionel26');
   define('DB_DATABASE', 'if0_36726746_jeda_design');
...
if (isset($_POST['reg_user'])) {
  ...
  if ($password_1 != $password_2) {
	array_push($errors, "Les deux mots de passen ne correcspondent pas");
  }
