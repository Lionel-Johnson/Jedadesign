                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 Avis(s) | Ajouter vote avis</a>
							</div>
							<div>
								<h3 class="product-price">Frs'.$row['product_price'].'<del class="product-old-price">40.000Frs</del></h3>
								<span class="product-available">En Stock</span>
							</div>
							<p>Lorem ipsum dolor sit amet,  ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" ><i class="fa fa-shopping-cart"></i> ajouter au panier</button>
                                </div>
							...
							<ul class="product-btns">
								<li><a href="#"><i class="fa fa-heart-o"></i> ajouter aux besoins</a></li>
								<li><a href="#"><i class="fa fa-exchange"></i> d</a></li>
							</ul>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Johnson</h5>
															<p class="date">17 Janv 2024, 13:16 </p>
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form">
													...
													<input class="input" type="email" placeholder="Votre E-mail">
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											...
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>d</span></button>
