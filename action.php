...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='aside'>
							<h3 class='aside-title'>Articles</h3>
							<div class='btn-group-vertical'>
	";
	if(mysqli_num_rows($run_query) > 0){
        $i=1;
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist' tabindex='0'><i class='fa fa-heart-o'></i><span class='tooltipp'>ajouter aux besoins</span></button>
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>ajouter aux comparaisons</span></button>
											<button class='quick-view' ><i class='fa fa-eye'></i><span class='tooltipp'>aperçu rapide</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> ajouter au panier</button>
									</div>
								</div>
							</div>
			";
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Le produit est déjà ajouté au panier Continuer les achats..!</b>
				</div>
			";//not in video
		} else {
			...
			if(mysqli_query($con,$sql)){
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Votre article a été ajouté à votre panier..!</b>
					</div>
				";
			}
		}
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>Frs'.$product_price.'</h4>
												</div>
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>Description du produit en cour de chargement,</p>
										</div>
									</div>
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continuer vos achats</a></td>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-success">Prêt à passer à la caisse</a></td>
								</tr>
							</tfoot>
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="contact@jedadesign.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-success" value="Prêt à passer à la caisse">
									</form></td>
...
if (isset($_POST["removeItemFromCart"])) {
	...
	if(mysqli_query($con,$sql)){
		echo "<div class='alert alert-danger'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Le produit est supprimé du panier</b>
				</div>";
		exit();
	}
}
