			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
							...
							<div class="store-sort">
								...
								Trier par:
									<select class="input-select">
										...
										<option value="1">Positionnement</option>
									</select>
								</label>
						...
						<!-- store bottom filter -->
						<div class="store-filter clearfix">
							<span class="store-qty">Afficher 20 à 100 articles</span>
