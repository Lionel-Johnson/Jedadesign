	...
	<div class="container-fluid">
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<div class="col-50">
							<label for="zip">Boîte Postale</label>
							<input type="text" id="zip" name="zip" class="form-control" pattern="^[0-9]{}(?:-[0-9]{4})?$" >
						</div>
						</div>
					</div>
					...
					<div class="col-50">
						...
						<label for="expdate">Date Exp</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Adresse de livraison identique à celle de facturation
					</label>';
					$i=1;
					$total=0;
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Poursuivre le Paiement" class="checkout-btn">
				</form>
				</div>
			</div>
			';
		...
		?>
			...
			<div class="col-25">
				...
				<h3>Total<span class='price' style='color:black'><b>$total Frs</b></span></h3>";
